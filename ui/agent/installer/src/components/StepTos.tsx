  ...
  return (
    <div className="space-y-4">
      ...
      <div
        ...
        className="h-56 overflow-y-auto rounded-lg border border-slate-800 bg-slate-950 p-4 text-xs text-slate-300 space-y-3 leading-relaxed shadow-inner"
      >
      ...
      <div className="space-y-3 pt-1">
        ...
        <label className="flex items-start gap-2.5 text-xs text-slate-200 cursor-pointer select-none">
          <input
            ...
            className="mt-0.5 rounded border-slate-700 bg-slate-950 text-cyan-600 focus:ring-0 focus:ring-offset-0"
          />
